...
str_extract_all(polls$dates, "\\d{1,2}\\s[A-Z][a-z]{2,4}")


data <- str_extract_all(polls$dates, "\\d{1,2}\\s[A-Z][a-z]{2,4}")
data1 <- str_extract_all(polls$dates, "\\d?\\s[a-zA-Z]?")
data2 <- str_extract_all(polls$dates, "\\d+\\s[a-zA-Z]+")
data3 <- str_extract_all(polls$dates, "\\d+\\s[A-Z]+")
data4 <- str_extract_all(polls$dates, "[0-9]+\\s[a-zA-Z]+")
data5 <- str_extract_all(polls$dates, "\\d{1,2}\\s[a-zA-Z]+")
data6 <- str_extract_all(polls$dates, "\\d{1,2}[a-zA-Z]+")
data7 <- str_extract_all(polls$dates, "\\d+\\s[a-zA-Z]{3,5}")

identical(data, data1)
identical(data, data2)
identical(data, data3)
identical(data, data4)
