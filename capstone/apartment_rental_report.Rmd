...
GENERATOR_SCRIPT_NAME <- "apartment_rental_project.R"

#Safe Load the files
safe_load_file <- function(file_name) {
  if(file.exists(file_name)){
    load(file_name)
  } else {
      message("The ", file_name, 
              " file is missing, please run the ", 
              GENERATOR_SCRIPT_NAME, " script first!")
  }
}
safe_load_file(MOVIELENS_DATA_FILE_NAME)
safe_load_file(MOVIELENS_REPORT_FILE_NAME)
```
