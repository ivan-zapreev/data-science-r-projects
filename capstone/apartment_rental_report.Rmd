...
cleaned_data_row_cnt <- nrow(arog_data$cleaned_data)
...
The data has been cleaned but we can expect that there is some noise in the data which we have not addressed. We might get more insights into the quality of data at hand when we perform data analysis in the subsequent sections.
